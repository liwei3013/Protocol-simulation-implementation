...
public:
	...
	//we add new constructor
	G1(const ECn& w) {mtable=NULL; mtbits=0; ptable=NULL; g=w;}
...
public:
	...
	GT(ZZn2& w){etable=NULL; etbits=0; g=w;}
	//we add new constructor
	GT(const ZZn2& w){etable=NULL; etbits=0; g=w;}
...
public:
	...
	//int precomp_for_mult(G1&,bool small);     // (precomputation may not be implemented!)
	//int precomp_for_power(GT&,bool small);    // returns number of precomputed values
